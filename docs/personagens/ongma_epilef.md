...
- **Herdança:** `extends EsqueletoPlayer` — mesmo kit que o [Esqueleto (baseline)](../esqueleto_personagem_base.md) (tiro carregado, triplo com mouse, raio G, etc.). Dash, wall jump e sprint estão em [`Player`](../../characters/player.gd) para todos os duelistas.
